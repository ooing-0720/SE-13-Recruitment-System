	...
	while (!isProgramExit) {
		...
		case 4:
		{
			...
			case 2:		// 4.2 채용 지원
			{
				...
				Apply tempApply = searchRecruitmentUI.ApplyEmployment(companyNumber, currentMember.getID(), recruitment);
			...
			case 4:		//4.4 지원 취소
			{
				...
				showApplyInformationUI = ShowApplyInformationUI(apply, recruitment);
